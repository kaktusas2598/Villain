...
namespace Villain {
    ...
    class ParticleAnchoredSpring: public ParticleForceGenerator {
        public:
            ParticleAnchoredSpring(const glm::vec3& anchor, float stifnessConstant, float springRestLength)
            ...
            virtual void updateForce(Particle* particle, float deltaTime) {
                ...
                float magnitude = fabsf(glm::length(force) - restLength) * springConstant;
